    ...
    <header className="bg-yellow-400">
      <nav className="flex justify-between w-5/6 mx-auto py-4">
        <div className="flex items-center">
          <img src={logo} alt="logo" className="logo h-10 w-15" />
          <span className="text-3xl text-slate-800 font-bold">MovieDB</span>
        </div>
        ...
        <ul className="flex items-center gap-8 text-slate-800 text-lg font-medium">
          ...
          <li>
            <NavLink to="/somepage">
              ...
              <span className="relative rounded-full bg-red-600 text-white -top-[10px] -left-[4px] text-xs p-[4px]">
                69
              </span>
            </NavLink>
          </li>
